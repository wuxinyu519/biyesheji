...
CREATE TABLE `t_liulangchongwu` (`id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流浪宠物id',`mingzi` varchar(255) DEFAULT NULL COMMENT '名字',`tupian` varchar(255) DEFAULT NULL COMMENT '图片',`jieshao` varchar(500) DEFAULT NULL COMMENT '介绍',`zhuyi` varchar(500) DEFAULT NULL COMMENT '注意事项',`leibie` varchar(255) DEFAULT NULL COMMENT '类别',`leibieid` int(11) DEFAULT NULL COMMENT '类别id',`state` varchar(255) DEFAULT NULL COMMENT '状态',  KEY `key_liulangchongwu_leibieid` (`leibieid`),
  CONSTRAINT `key_liulangchongwu_leibieid` FOREIGN KEY (`leibieid`) REFERENCES `t_leibie` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,PRIMARY KEY (`id`)
...
CREATE TABLE `t_lingyang` (`id` int(11) NOT NULL AUTO_INCREMENT COMMENT '领养id',`liulangchongwu` varchar(255) DEFAULT NULL COMMENT '宠物',`liulangchongwuid` int(11) DEFAULT NULL COMMENT '宠物id',`yonghu` varchar(255) DEFAULT NULL COMMENT '用户',`yonghuid` int(11) DEFAULT NULL COMMENT '用户id',`lyriqi` varchar(255) DEFAULT NULL COMMENT '领养日期',  KEY `key_lingyang_liulangchongwuid` (`liulangchongwuid`),
  CONSTRAINT `key_lingyang_liulangchongwuid` FOREIGN KEY (`liulangchongwuid`) REFERENCES `t_liulangchongwu` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,  KEY `key_lingyang_yonghuid` (`yonghuid`),
  CONSTRAINT `key_lingyang_yonghuid` FOREIGN KEY (`yonghuid`) REFERENCES `t_yonghu` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,PRIMARY KEY (`id`)
) ENGINE = INNODB DEFAULT CHARSET = utf8 COMMENT = '领养';-- ----------------------------

DROP TABLE IF EXISTS `t_liulangchongwupinglun`;

CREATE TABLE `t_liulangchongwupinglun` (`id` int(11) NOT NULL AUTO_INCREMENT COMMENT '宠物评论id',`liulangchongwu` varchar(255) DEFAULT NULL COMMENT '宠物',`liulangchongwuid` int(11) DEFAULT NULL COMMENT '宠物id',`neirong` varchar(500) DEFAULT NULL COMMENT '内容',`pinglunrenmingzi` varchar(255) DEFAULT NULL COMMENT '评论人名字',`pinglunrenid` int(11) DEFAULT NULL COMMENT '评论人id',`pinglunshijian` varchar(255) DEFAULT NULL COMMENT '评论时间',  KEY `key_liulangchongwupinglun_liulangchongwuid` (`liulangchongwuid`),
  CONSTRAINT `key_liulangchongwupinglun_liulangchongwuid` FOREIGN KEY (`liulangchongwuid`) REFERENCES `t_liulangchongwu` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,  KEY `key_liulangchongwupinglun_pinglunrenid` (`pinglunrenid`),
  CONSTRAINT `key_liulangchongwupinglun_pinglunrenid` FOREIGN KEY (`pinglunrenid`) REFERENCES `t_yonghu` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,PRIMARY KEY (`id`)
...
CREATE TABLE `t_dongtai` (`id` int(11) NOT NULL AUTO_INCREMENT COMMENT '动态id',`biaoti` varchar(255) DEFAULT NULL COMMENT '标题',`fabushijian` varchar(255) DEFAULT NULL COMMENT '发布时间',`neirong` varchar(500) DEFAULT NULL COMMENT '内容',`yonghu` varchar(255) DEFAULT NULL COMMENT '用户',`yonghuid` int(11) DEFAULT NULL COMMENT '用户id',`pic` varchar(255) DEFAULT NULL COMMENT '封面',  KEY `key_dongtai_yonghuid` (`yonghuid`),
  CONSTRAINT `key_dongtai_yonghuid` FOREIGN KEY (`yonghuid`) REFERENCES `t_yonghu` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,PRIMARY KEY (`id`)
) ENGINE = INNODB DEFAULT CHARSET = utf8 COMMENT = '动态';-- ----------------------------

DROP TABLE IF EXISTS `t_dongtaipinglun`;

CREATE TABLE `t_dongtaipinglun` (`id` int(11) NOT NULL AUTO_INCREMENT COMMENT '动态回复id',`dongtai` varchar(255) DEFAULT NULL COMMENT '动态',`dongtaiid` int(11) DEFAULT NULL COMMENT '动态id',`neirong` varchar(500) DEFAULT NULL COMMENT '内容',`pinglunrenmingzi` varchar(255) DEFAULT NULL COMMENT '回复人',`pinglunrenid` int(11) DEFAULT NULL COMMENT '回复人id',`pinglunshijian` varchar(255) DEFAULT NULL COMMENT '回复时间',  KEY `key_dongtaipinglun_dongtaiid` (`dongtaiid`),
  CONSTRAINT `key_dongtaipinglun_dongtaiid` FOREIGN KEY (`dongtaiid`) REFERENCES `t_dongtai` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,  KEY `key_dongtaipinglun_pinglunrenid` (`pinglunrenid`),
  CONSTRAINT `key_dongtaipinglun_pinglunrenid` FOREIGN KEY (`pinglunrenid`) REFERENCES `t_yonghu` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,PRIMARY KEY (`id`)
