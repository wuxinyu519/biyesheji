										...
										<c:if test="${ !empty dongtaiall}">
											...
											<c:forEach items="${ dongtaiall}" var="item">
												...
												<tr>
													...
													<td>
														<!--  定义修改动态按钮和删除动态按钮，修改提交地址为updatedongtai.action?id=${item.id}，删除提交地址为 deletedongtai.action?id=${item.id}-->

														<a href="updatedongtai.action?id=${item.id}">修改</a> <a
														href="deletedongtai.action?id=${item.id}">删除</a>
