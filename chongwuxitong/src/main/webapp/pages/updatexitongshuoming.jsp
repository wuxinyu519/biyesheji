					...
					<div class=" col-md-12">
						<div class="card card-shadow mb-4">
							<div class="card-header">
								<div class="card-title">修改系统说明</div>
							</div>
							<div class="card-body">
								<form action="updatexitongshuomingact.action" method="post"
									enctype="multipart/form-data">
									<input name='id' style='display: none;'
										value="${xitongshuoming.id}">
									<div class="form-group">
										<label class="col-sm-12 control-label">标题</label>
										<div class="col-sm-12">
											<!-- 定义标题input输入框，并从request中取值xitongshuoming.biaoti赋值  -->

											<input name="biaoti" value="${xitongshuoming.biaoti}"
												class="form-control">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-12">
											<!-- 定义模块input输入框，并从request中取值xitongshuoming.mokuai赋值  -->

											<input name="mokuai" value="${xitongshuoming.mokuai}"
												class="form-control">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-12">
											...
											<textarea id="neirong" name="neirong" style="height: 200px;"
												class="form-control">${xitongshuoming.neirong}</textarea>
											<!-- 加载富文本组件所需css和js  -->
