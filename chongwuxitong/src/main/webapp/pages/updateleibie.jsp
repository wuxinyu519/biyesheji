					...
					<div class=" col-md-12">
						<div class="card card-shadow mb-4">
							<div class="card-header">
								<div class="card-title">修改类别</div>
							</div>
							<div class="card-body">
								<form action="updateleibieact.action" method="post"
									enctype="multipart/form-data">
									<input name='id' style='display: none;' value="${leibie.id}">
									<div class="form-group">
										<label class="col-sm-12 control-label">名称</label>
										<div class="col-sm-12">
											<!-- 定义名称input输入框，并从request中取值leibie.mingcheng赋值  -->

											<input name="mingcheng" value="${leibie.mingcheng}"
												class="form-control">
										</div>
									</div>
