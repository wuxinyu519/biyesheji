...
<body>
	<div id="wrapper">
		...
		<section class="hero-sec bg-full"
			...
			<div class="caption">
				<h1 class="heading text-center">搜索流浪宠物</h1>
			</div>
		</section>
				...
				<div class="col-md-12">
					<div class="job-search-bar">
						<div class="search-bar text-center">
							<form action="searchliulangchongwu.action" class="" method="post">
								<div class="form-row">
									<div class="col-md-6">
								...
								<c:forEach items="${ liulangchongwuall}" var="item">
									...
									<div class="product-col oneitem">
										<div class="img-holder">
											<img src="resource/uploads/${item.tupian}"
												style="width: 280px; height: 280px;" alt="food-img"
												class="img-responsive">
										</div>
										<div class="descrip">
											<h3 class="heading2">${item.mingzi}</h3>
										</div>
