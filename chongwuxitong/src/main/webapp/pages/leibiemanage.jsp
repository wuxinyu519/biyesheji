										...
										<c:if test="${ !empty leibieall}">
											...
											<c:forEach items="${ leibieall}" var="item">
												...
												<tr>
													...
													<td>
														<!--  定义修改类别按钮和删除类别按钮，修改提交地址为updateleibie.action?id=${item.id}，删除提交地址为 deleteleibie.action?id=${item.id}-->

														<a href="updateleibie.action?id=${item.id}">修改</a> <a
														href="deleteleibie.action?id=${item.id}">删除</a>
