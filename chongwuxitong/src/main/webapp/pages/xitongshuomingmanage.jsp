					...
					<div class=" col-sm-12">
						<div class="card card-shadow mb-4">
							<div class="card-header">
								<div class="card-title">系统说明管理</div>
							</div>
							<div class="card-body">
										...
										<c:if test="${ !empty xitongshuomingall}">
											...
											<c:forEach items="${ xitongshuomingall}" var="item">
												...
												<tr>
													...
													<td>${item.neirong }</td>
													<td>
														<!--  定义修改系统说明按钮和删除系统说明按钮，修改提交地址为updatexitongshuoming.action?id=${item.id}，删除提交地址为 deletexitongshuoming.action?id=${item.id}-->

														<a href="updatexitongshuoming.action?id=${item.id}">修改</a>
														<a href="deletexitongshuoming.action?id=${item.id}">删除</a>
