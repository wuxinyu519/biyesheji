											...
											<c:forEach items="${ dongtaiall}" var="item">
												...
												<tr>
													...
													<td>
														...
														href="resource/uploads/${item.pic }"><img
															src="resource/uploads/${item.pic }"
															style="height: 100px; width: 100px;" /></a>

													</td>
													<td>
														<!--  定义修改动态按钮和删除动态按钮，修改提交地址为yonghuupdatedongtai.action?id=${item.id}，删除提交地址为 yonghudeletedongtai.action?id=${item.id}-->

														<a href="yonghuupdatedongtai.action?id=${item.id}">修改</a>
														<a href="yonghudeletedongtai.action?id=${item.id}">删除</a>
