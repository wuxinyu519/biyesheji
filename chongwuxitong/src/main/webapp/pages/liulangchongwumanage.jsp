					...
					<div class=" col-sm-12">
						<div class="card card-shadow mb-4">
							<div class="card-header">
								<div class="card-title">流浪宠物管理</div>
							</div>
							<div class="card-body">
											...
											<c:forEach items="${ liulangchongwuall}" var="item">
												...
												<tr>
													...
													<td>
														...
														href="resource/uploads/${item.tupian }"><img
															src="resource/uploads/${item.tupian }"
													...
													<td>${item.state }</td>
													<td>
														<!--  定义修改流浪宠物按钮和删除流浪宠物按钮，修改提交地址为updateliulangchongwu.action?id=${item.id}，删除提交地址为 deleteliulangchongwu.action?id=${item.id}-->

														<a href="updateliulangchongwu.action?id=${item.id}">修改</a>
														<a href="deleteliulangchongwu.action?id=${item.id}">删除</a>
