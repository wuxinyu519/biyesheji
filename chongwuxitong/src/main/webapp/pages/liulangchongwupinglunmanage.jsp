										...
										<c:if test="${ !empty liulangchongwupinglunall}">
											...
											<c:forEach items="${ liulangchongwupinglunall}" var="item">
												...
												<tr>
													...
													<td>
														<!--  定义修改宠物评论按钮和删除宠物评论按钮，修改提交地址为updateliulangchongwupinglun.action?id=${item.id}，删除提交地址为 deleteliulangchongwupinglun.action?id=${item.id}-->

														<a href="updateliulangchongwupinglun.action?id=${item.id}">修改</a>
														<a href="deleteliulangchongwupinglun.action?id=${item.id}">删除</a>
